...
parental_contribution <- function(result_df) {
  result_df$similarity_offspring_parent1 <- result_df$offspring_Parent1_Common / result_df$offspring_Parent1_total
  result_df$similarity_offspring_parent2 <- result_df$offspring_Parent2_Common / result_df$offspring_Parent2_total
  result_df$similarity_parent1_parent2 <-  result_df$parent1_parent2_common / result_df$Parent1_Parent2_total

  result_df$contribution_parent1 <- (result_df$similarity_offspring_parent1 - (result_df$similarity_offspring_parent2 * result_df$similarity_parent1_parent2)) /
    (1 - (result_df$similarity_parent1_parent2 * result_df$similarity_parent1_parent2))

  result_df$contribution_parent2 <- (result_df$similarity_offspring_parent2 - (result_df$similarity_offspring_parent1 * result_df$similarity_parent1_parent2)) /
    (1 - (result_df$similarity_parent1_parent2 * result_df$similarity_parent1_parent2))
